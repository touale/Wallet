...
import cn.edu.gzhu.BIP32.util.ByteArrayWriter;
...
import static cn.edu.gzhu.BIP32.HmacSha512.hmacSha512;
import static cn.edu.gzhu.BIP32.Secp256k1SC.n;
import static cn.edu.gzhu.BIP32.util.BigIntegerUtils.parse256;
import static cn.edu.gzhu.BIP32.util.BigIntegerUtils.ser256;
import static cn.edu.gzhu.BIP32.util.ByteArrayWriter.head32;
import static cn.edu.gzhu.BIP32.util.ByteArrayWriter.tail32;
...
public final class ExtendedPrivateKey implements
    ...
    public static ExtendedPrivateKey fromSeed(final byte[] seed, final Bitcoin network) {
