...
public final class Secp256k1SC {
    ...
    public static byte[] pointSerP(final ECPoint point) {
    ...
    public static ECPoint gMultiplyAndAddPoint(final BigInteger p, final byte[] toAdd) {
