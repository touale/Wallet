...
import static cn.edu.gzhu.BIP32.util.Checksum.checksum;
...
public final class Serializer {
    ...
    public byte[] serialize(final byte[] key, final byte[] chainCode) {
        if (key == null)
    ...
    public static class Builder {
        ...
        public Builder fingerprint(final int fingerprint) {
